...
from sky_app.constant import FEE

# bu esa chiptani pdf holatga keltirish bu tayyor olinga kod
...
def createticket(user,passengers,passengerscount,flight1,flight_1date,flight_1class,coupon,countrycode,email,mobile):
    ...
    if coupon:
        ticket.coupon_used = coupon                     ##########Kupon
    ticket.total_fare = ffre+FEE+0.0                    ##########Kupondan keyingi umumiy qiymat
